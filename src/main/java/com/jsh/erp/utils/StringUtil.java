...
public class StringUtil {
    ...
    public static BigDecimal parseBigDecimalEx(String str) throws Exception {
     ...
     * @return
     */
    public static boolean isPositiveLongWithLength5(Object value) {
        if (value != null) {
            String str = value.toString();
            if (isNotEmpty(str) && str.length() == 5) {
                if ((str.matches("[0-9]+")) && (Long.parseLong(str) > 0)) {
                    return true;
                } else {
                    return false;
