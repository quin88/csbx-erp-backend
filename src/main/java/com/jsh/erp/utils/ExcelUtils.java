...
public class ExcelUtils {
	...
	public static File exportObjectsWithoutTitle(String fileName, String tip,
		...
		exportSheet(tip, names, objects, sheet);
		wtwb.write();
		wtwb.close();
		return excelFile;
	}

	public static void exportSheet(String tip, String[] names, List<String[]> objects, WritableSheet sheet) throws WriteException {
	...
	public static Date getDate(Sheet src, int rowNum, int colNum) {
		String content = getContent(src, rowNum, colNum);
