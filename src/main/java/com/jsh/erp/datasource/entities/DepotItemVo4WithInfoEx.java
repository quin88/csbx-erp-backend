...
public class DepotItemVo4WithInfoEx extends DepotItem{
    ...
    private Date depotHeadOperTime;//出入库时间
    ...
    public Date getDepotHeadOperTime() {
        return depotHeadOperTime;
    }

    public void setDepotHeadOperTime(Date depotHeadOperTime) {
        this.depotHeadOperTime = depotHeadOperTime;
    }
}