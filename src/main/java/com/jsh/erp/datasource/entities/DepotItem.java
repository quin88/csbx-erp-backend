...
public class DepotItem implements Serializable {
    ...
    private Long anotherGoodsAllocationId;
    ...
    public Long getAnotherGoodsAllocationId() {
        return anotherGoodsAllocationId;
    }

    public void setAnotherGoodsAllocationId(Long anotherGoodsAllocationId) {
        this.anotherGoodsAllocationId = anotherGoodsAllocationId;
    }
}