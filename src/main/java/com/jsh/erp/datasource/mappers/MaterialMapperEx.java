...
public interface MaterialMapperEx {
    ...
    List<MaterialVo4Unit> findBySelectWithBarCode(@Param("supplierId") Long supplierId,
                                                  @Param("idList") List<Long> idList,
                                                  @Param("q") String q,
                                                  @Param("enableSerialNumber") String enableSerialNumber,
                                                  @Param("enableBatchNumber") String enableBatchNumber,
                                                  @Param("zeroStockFilter") Integer zeroStockFilter,
                                                  @Param("offset") Integer offset,
                                                  @Param("rows") Integer rows);

    int findBySelectWithBarCodeCount(@Param("supplierId") Long supplierId,
                                     @Param("idList") List<Long> idList,
                                     @Param("q") String q,
                                     @Param("enableSerialNumber") String enableSerialNumber,
                                     @Param("enableBatchNumber") String enableBatchNumber,
