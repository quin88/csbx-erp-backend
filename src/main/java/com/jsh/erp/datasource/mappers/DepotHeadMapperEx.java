...
public interface DepotHeadMapperEx {
    ...
    List<MaterialsBarCodeListVo> findMaterialsBarCodeListMapByHeaderIdList(
            @Param("idList") List<Long> idList);
    ...
    List<DepotHeadVo6List> getListByStatus(
            @Param("subType")String subType,
            @Param("supplierId") Long supplierId,
            @Param("statusArray") String[] statusArray,
            @Param("offset") Integer offset,
    ...
    int getCountByStatus( @Param("subType")String subType,
                          @Param("supplierId") Long supplierId,
                          @Param("statusArray") String[] statusArray);

    BigDecimal getBuyAndSaleStatisticsBySupplier(@Param("type") String type,
                                                 @Param("subType") String subType,
                                                 @Param("supplierId") Long supplierId,
                                                 @Param("beginTime") String beginTime,
                                                 @Param("endTime") String endTime);

    DepotHeadVoInOutSCount findInOutSupplierCountTotal(@Param("beginTime") String beginTime,
                                                       @Param("endTime") String endTime,
                                                       @Param("supplierId") Long supplierId);
}
