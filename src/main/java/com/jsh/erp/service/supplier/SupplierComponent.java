...
public class SupplierComponent implements ICommonQuery {
    ...
    private List<?> getSupplierList(Map<String, String> map) throws Exception {
        ...
        return supplierService.select(supplier, type, phonenum, telephone, checkStatus, QueryUtils.offset(map), QueryUtils.rows(map));
    }
    ...
    public Long counts(Map<String, String> map) throws Exception {
        ...
        String telephone = StringUtil.getInfo(search, "telephone");
        String checkStatus = StringUtil.getInfo(search, "checkStatus");
        return supplierService.countSupplier(supplier, type, phonenum, telephone, checkStatus);
    }
