...
public class MaterialComponent implements ICommonQuery {
    ...
    private List<?> getMaterialList(Map<String, String> map) throws Exception {
        ...
        String approvalStatus = StringUtil.getInfo(search, "approvalStatus");
        Long supplierId = StringUtil.parseStrLong(StringUtil.getInfo(search, "supplierId"));
        String originType = StringUtil.getInfo(search, "originType");
        return materialService.select(materialParam, color, materialOther, weight, expiryNum,
                enableSerialNumber, enableBatchNumber, enabled, remark, categoryId, mpList, approvalStatus, supplierId,
                originType, QueryUtils.offset(map), QueryUtils.rows(map));
    }
    ...
    public Long counts(Map<String, String> map) throws Exception {
        ...
        return materialService.countMaterial(materialParam, color, materialOther, weight, expiryNum,
                enableSerialNumber, enableBatchNumber, enabled, remark, categoryId, mpList, approvalStatus, supplierId, originType);
    }
