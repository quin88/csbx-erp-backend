...
public class RedisService {
    ...
    public void storageObjectBySessionToMiniProgram(String token, String key, Object obj) {
        //开启redis，用户数据放到redis中
        redisTemplate.opsForHash().put(token, key, obj.toString());
        redisTemplate.expire(token, BusinessConstants.MINI_PROGRAM_MAX_SESSION_IN_SECONDS, TimeUnit.SECONDS);
    }
    /**
     * @author jisheng hua
     * description:
