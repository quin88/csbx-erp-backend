...
public class ExceptionConstants {
     ...
     * 当前状态不支持执行此操作
     */
    public static final int UPDATE_STATUS_FAILED_CODE = 13500000;
    public static final String UPDATE_STATUS_FAILED_MSG = "抱歉，当前状态不支持执行此操作";
    /**
     * 用户信息
     * type = 5
     */
    ...
    //手机号格式错误
    public static final int USER_PHONE_IS_INVALID_CODE = 500010;
    public static final String USER_PHONE_IS_INVALID_MSG = "手机号格式错误";
    //验证码错误
    public static final int USER_VERIFICATION_CODE_ERROR_CODE = 500011;
    public static final String USER_VERIFICATION_CODE_ERROR_MSG = "验证码错误";

    public static final int USER_LOGIN_PHONE_ALREADY_EXISTS_CODE = 500012;
    public static final String USER_LOGIN_PHONE_ALREADY_EXISTS_MSG = "手机号已经注册，请进行登录";

    public static final int USER_LOGIN_PHONE_NUMBER_SMS_HAS_REACHED_THE_LIMIT_CODE = 500013;
    public static final String USER_LOGIN_PHONE_NUMBER_SMS_HAS_REACHED_THE_LIMIT_MSG = "该手机号今日发送验证码次数已达上限，请明日再试!";

    public static final int USER_LOGIN_EXPIRED_STATUS_CODE = 500014;
    public static final String USER_LOGIN_EXPIRED_STATUS_MSG = "登录过期，请重新登录";
    ...
    //仓库不存在
    public static final int DEPOT_IS_EMPTY_OVER_CODE = 2000003;
    public static final String DEPOT_IS_EMPTY_OVER_MSG = "第%s行仓库名称为空或不存在于系统中";
    //仓库长度超出
    public static final int DEPOT_NAME_OVER_CODE = 2000004;
    public static final String DEPOT_NAME_OVER_MSG = "第%s行仓库名称长度超出20个字符";
    //货位为空
    public static final int GOODS_ALLOCATION_IS_EMPTY_OVER_CODE = 2000005;
    public static final String GOODS_ALLOCATION_IS_EMPTY_OVER_MSG = "第%s行货位名称不能为空";
    //货位长度超出
    public static final int GOODS_ALLOCATION_NAME_OVER_CODE = 2000006;
    public static final String GOODS_ALLOCATION_NAME_OVER_MSG = "第%s行货位名称长度超出50个字符";
    //货位编号出现重复
        public static final int GOODS_ALLOCATION_NUMBER_REPETITION_OVER_CODE = 2000007;
    public static final String GOODS_ALLOCATION_NUMBER_REPETITION_OVER_MSG = "货位编号重复";
    //货位名称和仓库出现重复--excel导入
    public static final int EXCEL_GOODS_ALLOCATION_NAME_REPETITION_OVER_CODE = 2000008;
    public static final String EXCEL_GOODS_ALLOCATION_NAME_REPETITION_OVER_MSG = "第%s行货位名称和仓库出现重复";
    /**
     * 功能模块信息
     * type = 30
     */
    ...
    //供应商启用-只有未启用的供应商才能启用
    public static final int SUPPLIER_UPDATE_ACTIVE_TURE_FAILED_CODE = 7000003;
    public static final String SUPPLIER_UPDATE_ACTIVE_TURE_FAILED_MSG = "抱歉，只有已审核且未启用的供应商才能启用";
    //供应商启用-只有已启用的供应商才能禁用
    public static final int SUPPLIER_UPDATE_ACTIVE_FALSE_FAILED_CODE = 7000004;
    public static final String SUPPLIER_UPDATE_ACTIVE_FALSE_FAILED_MSG = "抱歉，只有已审核且已启用的供应商才能禁用";
    /**
     * 商品类别信息
     * type = 75
     */
    ...
    //编号已经存在
    public static final int IMPORT_MATERIAL_CATEGORY_SERIAL_ALREADY_EXISTS_CODE = 7500007;
    public static final String IMPORT_MATERIAL_CATEGORY_SERIAL_ALREADY_EXISTS_MSG = "抱歉，第%s行编码已经存在";
    //名称已经存在
    public static final int IMPORT_MATERIAL_CATEGORY_NAME_ALREADY_EXISTS_CODE = 7500008;
    public static final String IMPORT_MATERIAL_CATEGORY_NAME_ALREADY_EXISTS_MSG = "抱歉，第%s行名称已经存在";
    /**
     * 商品信息
     * type = 80
     */
    ...
    public static final String MATERIAL_EXTENSION_ERROR_MSG = "抱歉，文件扩展名必须为xls或者xlsx";
    //名称为空
    ...
    //供应商不能为空
    public static final int MATERIAL_SUPPLIER_OVER_CODE = 8000025;
    public static final String MATERIAL_SUPPLIER_OVER_MSG = "第%s行供应商名称为空或不存在于系统中";
    ...
    public static final String DEPOT_HEAD_UN_AUDIT_DELETE_FAILED_MSG = "抱歉，当前状态不能删除";
    //单据审核-只有未审核的单据才能审核
     ...
     */
    //编辑供应商充值信息失败
    public static final int PAYMENT_RECORDS_UPDATE_FAILED_CODE = 12000000;
    public static final String PAYMENT_RECORDS_UPDATE_FAILED_MSG = "抱歉，只有未审核的单据才能编辑";
    //新增供应商充值信息失败
    public static final int PAYMENT_RECORDS_ADD_FAILED_CODE = 12000001;
    public static final String PAYMENT_RECORDS_ADD_FAILED_MSG = "该供应商已有充值信息，当前状态仅支持续费";

    /**
     * 供应商余额信息
     */
    //供应商未充值
    public static final int BALANCE_RECORDS_SUBTRACT_FAILED_CODE = 12500000;
    public static final String BALANCE_RECORDS_SUBTRACT_FAILED_MSG = "扣除供应商余额失败，该供应商无充值信息或余额不足";

    /**
     * 子账户信息
     */
    //启用的子账户不能被删除
    public static final int DELETE_ACTIVE_SUPPLIER_EXTEND_FAILED_CODE = 13000000;
    public static final String DELETE_ACTIVE_SUPPLIER_EXTEND_FAILED_MSG = "启用的子账户不能被删除";
    //子账户审核-只有未审核的子账户才能审核
    public static final int SUPPLIER_EXTEND_UN_AUDIT_TO_AUDIT_FAILED_CODE = 13000001;
    public static final String SUPPLIER_EXTEND_UN_AUDIT_TO_AUDIT_FAILED_MSG = "抱歉，只有未审核的子账户才能审核";
    //子账户反审核-只有已审核的子账户才能反审核
    public static final int SUPPLIER_EXTEND_AUDIT_TO_UN_AUDIT_FAILED_CODE = 13000002;
    public static final String SUPPLIER_EXTEND_AUDIT_TO_UN_AUDIT_FAILED_MSG = "抱歉，只有已审核的子账户才能反审核";
    //子账户启用-只有未启用的子账户才能启用
    public static final int SUPPLIER_EXTEND_UPDATE_ACTIVE_TURE_FAILED_CODE = 13000001;
    public static final String SUPPLIER_EXTEND_UPDATE_ACTIVE_TURE_FAILED_MSG = "抱歉，只有已审核且未启用的子账户才能启用";
    //子账户启用-只有已启用的子账户才能禁用
    public static final int SUPPLIER_EXTEND_UPDATE_ACTIVE_FALSE_FAILED_CODE = 13000002;
    public static final String SUPPLIER_EXTEND_UPDATE_ACTIVE_FALSE_FAILED_MSG = "抱歉，只有已审核且已启用的子账户才能禁用";
    //子账户启用-超出启用数量
    public static final int SUPPLIER_EXTEND_CREATED_MORE_THAN_FAILED_CODE = 13000003;
    public static final String SUPPLIER_EXTEND_CREATED_MORE_THAN_FAILED_MSG = "抱歉，本账户最多可创建%s个子账户";

    //子账户启用-超出启用数量
    public static final int SUPPLIER_EXTEND_UPDATE_ACTIVE_MORE_THAN_FAILED_CODE = 13000004;
    public static final String SUPPLIER_EXTEND_UPDATE_ACTIVE_MORE_THAN_FAILED_MSG = "抱歉，本账户最多可启用%s个子账户";

    /**
     * 增值服务
     */
    //启用的子账户不能被删除
    public static final int DELETE_ACTIVE_VALUE_ADDED_FAILED_CODE = 13100000;
    public static final String DELETE_ACTIVE_VALUE_ADDED_FAILED_MSG = "启用的增值服务不能被删除";

    /**
     * 货位管理
     */
    //货位启用-只有未启用的货位才能启用
    public static final int GOODS_ALLOCATION_UPDATE_ACTIVE_TURE_FAILED_CODE = 14000001;
    public static final String GOODS_ALLOCATION_UPDATE_ACTIVE_TURE_FAILED_MSG = "抱歉，只有未启用的货位才能启用";
    //货位启用-只有已启用的货位才能禁用
    public static final int GOODS_ALLOCATION_UPDATE_ACTIVE_FALSE_FAILED_CODE = 14000002;
    public static final String GOODS_ALLOCATION_UPDATE_ACTIVE_FALSE_FAILED_MSG = "抱歉，只有已启用的货位才能禁用";
    /**
     * 子账户信息
     */
    //启用的子账户不能被删除
    public static final int DELETE_ACTIVE_GOODS_ALLOCATION_FAILED_CODE = 14000003;
    public static final String DELETE_ACTIVE_GOODS_ALLOCATION_FAILED_MSG = "启用的货位不能被删除";

    /**
     * 个人补单
     */
    //启用的子账户不能被删除
    public static final int SUPPLIER_ADDED_ORDER_SAVE_IMAGE_FAILED_CODE = 1410000;
    public static final String SUPPLIER_ADDED_ORDER_SAVE_IMAGE_FAILED_MSG = "图片名称太长，请修改";

    /**
     * 微信二维码调用失败
     */
    public static final int GET_WECHAT_QRCODE_FAILED_CODE = 14500000;
    public static final String GET_WECHAT_QRCODE_FAILED_MSG = "获取微信二维码失败，请联系后台管理员";

    /**
     * 创建唯一编码错误
     */

    public static final int SERIAL_NUMBERE_NOT_ENOUGH_CODE = 15000000;
    public static final String SERIAL_NUMBERE_NOT_ENOUGH_MSG = "序列号不充足，请补充后重试";

    /**
     * 商超供应商-未审核的供应商不能启用
     */
    public static final int SUPERMARKET_SUPPLIER_UPDATE_ENABLE_TRUE_FAILED_CODE = 14000002;
    public static final String SUPERMARKET_SUPPLIER_UPDATE_ENABLE_TRUE_FAILED_CODE_MSG = "抱歉，%s审核未通过暂不能启用，请审核通过后重试";

    /**
     * 商超订单
     */
    public static final int SUPERMARKET_ORDER_CANNOT_EDIT_CODE = 15500000;
    public static final String SUPERMARKET_ORDER_CANNOT_EDIT_MSG = "抱歉，当前状态下不能修改";

    //编码已经存在
    public static final int NUMBER_IS_EXIST_CODE = 16000000;
    public static final String NUMBER_IS_EXIST_MSG = "抱歉，该编码已存在";

    /**
     * 商超商品
     */
    public static final int SUPERMARKET_MATERIAL_UN_AUDIT_DELETE_FAILED_CODE = 16500000;
    public static final String SUPERMARKET_MATERIAL_UN_AUDIT_DELETE_FAILED_MSG = "抱歉，当前状态不能删除";


    /**
     * 商超商品
     */
    public static final int SUPERMARKET_ACCOUNT_NUMBER_IS_EXIST_CODE = 17000000;
    public static final String SUPERMARKET_ACCOUNT_NUMBER_IS_EXIST_MSG = "抱歉，%s该银行账号已经存在";

    /**
     * 商超出入库
     */
    //已提交不能被删除
    public static final int SUPERMARKET_DOCUMENT_DELETE_FAILED_CODE = 17500000;
    public static final String SUPERMARKET_DOCUMENT_DELETE_FAILED_MSG = "已提交的订单不能被删除";

    /**
     * 商超财务
     */
    //存在被关联订单
    public static final int SUPERMARKET_FINANCE_HAS_ORDER_CODE = 17510000;
    public static final String SUPERMARKET_FINANCE_HAS_ORDER_MSG = "关联订单中存在已被关联的订单";

    /**
     * 市场管理
     */
    //只有未挂钩供应商的市场可以删除
    public static final int MARKET_DELETE_FAILED_CODE = 18000000;
    public static final String MARKET_DELETE_FAILED_MSG = "所选择的市场中有挂钩供应商，不能删除";

    /**
     * 产地管理
     */
    public static final int COUNTY_DELETE_FAILED_CODE = 18500000;
    public static final String COUNTY_DELETE_FAILED_MSG = "所选择的产地中有挂钩商品，不能删除";

    /**
     * 商超租户配置
     */
    //商超订单编号前缀-已经存在
    public static final int SUPERMARKET_ORDER_NUMBER_PREFIX_EXIST_CODE = 19000000;
    public static final String SUPERMARKET_ORDER_NUMBER_PREFIX_EXIST_MSG = "您已创建编号前缀";

    public static final int SUPERMARKET_SYSTEM_CONFIG_NOT_EXIST_CODE = 19000001;
    public static final String SUPERMARKET_SYSTEM_CONFIG_NOT_EXIST_MSG = "尚未配置租户配置，请前往系统管理-商超配置";

    public static final int SUPERMARKET_TAX_EXIST_CODE = 19000002;
    public static final String SUPERMARKET_TAX_EXIST_MSG = "该服务商已有税率";

    public static final int SUPERMARKET_PAYMENT_CONFIG_EXIST_CODE = 19000003;
    public static final String SUPERMARKET_PAYMENT_CONFIG_EXIST_MSG = "存在相同付款配置";
    /**
     * 费用类型配置
     */
    public static final int SETTLEMENT_NAME_EXIST_CODE = 19500000;
    public static final String SETTLEMENT_NAME_EXIST_EXIST_MSG = "抱歉，%s结算方式已存在！";

    public static final int SECOND_SETTLEMENT_NAME_EXIST_CODE = 19500001;
    public static final String SECOND_SETTLEMENT_NAME_EXIST_EXIST_MSG = "抱歉，%s费用方式已存在！";
