        ...
        try {
            ...
            if (null != dataList) {
                ...
                for (DepotItemVo4WithInfoEx diEx : dataList) {
                    ...
                    item.put("weight", diEx.getWeight() == null ? BigDecimal.ZERO : diEx.getWeight());
                    item.put("totalWeight", diEx.getTotalWeight());
                    ...
                    item.put("numberOfPanels", diEx.getNumberOfPanels());
                    item.put("numberOfPallets", diEx.getNumberOfPallets());
                    item.put("producingArea", diEx.getProducingArea());
                    item.put("productionDate", diEx.getProductionDate());
                    item.put("imgName", diEx.getImgName());

                    item.put("goodsAllocationId", diEx.getGoodsAllocationId() == null ? "" : diEx.getGoodsAllocationId());
                    item.put("goodsAllocationName", diEx.getGoodsAllocationId() == null ? "" : diEx.getGoodsAllocationName());
                    item.put("anotherGoodsAllocationId", diEx.getAnotherGoodsAllocationId() == null ? "" : diEx.getAnotherGoodsAllocationId());
                    item.put("anotherGoodsAllocationName", diEx.getAnotherGoodsAllocationId() == null ? "" : diEx.getAnotherGoodsAllocationName());
                    item.put("expiryNum", diEx.getExpiryNum() == null ? "" : diEx.getExpiryNum());
                    dataArray.add(item);
                    //合计数据汇总
                    ...
                    totalWeight = totalWeight.add(diEx.getTotalWeight() == null ? BigDecimal.ZERO : diEx.getTotalWeight());
                }
...
//                    footItem.put("taxMoney", totalTaxMoney);
                    ...
                    footItem.put("totalWeight", totalWeight);
