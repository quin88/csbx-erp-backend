...
public class UserController {
    ...
    @Value("${MINIPROGRAM.TOKEN}")//小程序登录账户设置固定token
    private String mini_program_token;
        ...
        try {
            ...
            switch (userStatus) {
                ...
                case ExceptionCodeConstants.UserExceptionCode.USER_CONDITION_FIT:
                    ...
                    if ("WeChat".equals(user.getLoginName())){
                        redisService.storageObjectBySessionToMiniProgram(mini_program_token,"userId",user.getId());
                    } else {
            ...
            if(user!=null){
                ...
                if ("WeChat".equals(user.getLoginName())){//小程序用户token固定
                    data.put("token", mini_program_token);
                } else {
